    ...
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex">
            ...
            <div class="ml-12 mr-64">
                ...
                <p class="mt-12">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus architecto consequuntur earum
                    esse est ex fugiat fugit maiores modi nesciunt quidem quisquam sed sequi, suscipit ullam. Dolorem
                    ducimus magnam mollitia!
                </p>
                <div class="mt-12">
                    <button
                        class="flex bg-blue-500 text-white font-semibold px-4 py-4 hover:bg-blue-600 rounded transition duration-150 transform hover:scale-110">
                ...
                <div>
                    <a href="#">
                        <img src="/screenshot1.jpg" alt="screenshot"
                             class="hover:opacity-75 transition duration-150 transform hover:scale-110"/>
                    </a>
                </div>
                <div>
                    <a href="#">
        ...
        <div class="similiar-games-container mt-8">
            <h2 class="text-blue-500 uppercase tracking-wide font-semibold">Similiar Games</h2>
            <div
                    ...
                    <div class="relative inline-block">
                        <a href="#">
                            <img src="/ff7.jpg" alt="game cover"
                                 class="transition duration-150  hover:opacity-75 transform hover:scale-110">
                        </a>
